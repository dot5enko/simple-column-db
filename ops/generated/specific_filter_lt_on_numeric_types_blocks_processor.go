...
func SpecificFilterLtOnNumericTypesBlocksProcessor[T ops.NumericTypes](fIdx int, slabMergerContext *executortypes.BlockMergerContext, operand0 T) (result executortypes.SingleColumnProcessingResult) {
...

		{
			...
			if blockGroupMerger.FullSkip() {
				...
				if headerMatchResult == schema.FullIntersection {
					...
					ops.CompareValuesAreSmallerBitset(inputArray, operand0, &outputBitset)
