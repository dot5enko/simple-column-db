...
func SpecificFilterEqOnNumericTypesBlocksProcessor[T ops.NumericTypes](fIdx int,slabMergerContext *executortypes.BlockMergerContext,operand0 T)  (result executortypes.SingleColumnProcessingResult) {
